...
$sql = "INSERT INTO MOVIES1 VALUES('Avengers_age_of_ultron', 'Mark Ruffalo', 'scarlet johanson', '2011-04-03', 'john wat')";
if ($conn->query($sql) === TRUE) {
  //echo "Database created successfully";
} else {
  //echo "Error creating database: " . $conn->error;
}
$sql = "INSERT INTO MOVIES1 VALUES('Power of dog', 'Bendict Ruffalo', 'thomh johanson', '2016-04-03','jmes campion')";
if ($conn->query($sql) === TRUE) {
  //echo "Database created successfully";
} else {
  //echo "Error creating database: " . $conn->error;
...
$sql = "INSERT INTO MOVIES1 VALUES('Thor', 'Chris Hemshworth', 'portman johanson', '2019-04-03','taika watiti')";
if ($conn->query($sql) === TRUE) {
  //echo "Database created successfully";
} else {
  //echo "Error creating database: " . $conn->error;
